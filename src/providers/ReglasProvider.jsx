...
function ReglasModal({ show, close }) {
  ...
  const [rules] = useState([
    ...
    { text: "Estacion 3 (Fritura): Enciende el aceite haciendo click a las freidoras, espera un poco a que se caliente el aceite, y arrastra las croquetas a las freidoras, cuando su estado de cocción sea el deseado por el cliente haz click nuevamente a la freidora y se sacarán automáticamente", image: "/images/fritura.gif" },
